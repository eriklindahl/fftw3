 ...
 *
 * AVX2 implementation by Erik Lindahl, 2015.
...
/* FMA support */
#define VFMA(a, b, c)  SUFF(_mm256_fmadd_p)(a,b,c)
#define VFNMS(a, b, c) SUFF(_mm256_fnmadd_p)(a,b,c)
#define VFMS(a, b, c)  SUFF(_mm256_fmsub_p)(a,b,c)
...
static inline V VZMUL(V tx, V sr)
{
  ...
  return SUFF(_mm256_fmaddsub_p)(tr,sr,ti);
}
...
static inline V VZMULJ(V tx, V sr)
{
     ...
     V ti = VDUPH(tx);
     ti = VMUL(ti,FLIP_RI(sr));
     return SUFF(_mm256_fmsubadd_p)(tr,sr,ti);
}
...
static inline V VZMULI(V tx, V sr)
{
     ...
     ti = VMUL(ti, sr);
     sr = VBYI(sr);
     /* Cannot find a subadd/addsub version using less than 5 instructions for AVX2 */
...
static inline V VZMULIJ(V tx, V sr)
{
     ...
     return SUFF(_mm256_fmaddsub_p)(ti,sr,tr);
}
